...
const ApplePage = lazy(() => import('./pages/ApplePage').then((module) => ({ default: module.ApplePage })))

function GameLoading() {
  return <div className="game-loading"><span className="button-loader" /> GAME LOADING</div>
}
      ...
      <ProfileProvider>
        ...
        <Routes>
          <Route element={<AppShell />}>
            ...
            <Route path="play/apple" element={<Suspense fallback={<GameLoading />}><ApplePage /></Suspense>} />
