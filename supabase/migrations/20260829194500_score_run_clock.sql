-- Use wall-clock time inside the score transaction for authoritative elapsed time.
...
begin
  ...
  insert into public.leaderboard_scores (
    ...
    p_device_id, clean_name, p_game, p_score, server_duration_ms, 1, clock_timestamp()
  )
